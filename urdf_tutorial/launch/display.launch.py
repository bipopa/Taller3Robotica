...
def generate_launch_description():
    ...
    default_model_path = os.path.join(pkg_share, 'urdf/punto1.urdf')
    robot_name_in_urdf = 'physics'
    ...
    start_robot_state_publisher_cmd = Node(
        ...
        parameters=[{'use_sim_time': use_sim_time, 'robot_description': Command(['xacro ',
                                                                                   model])}],
